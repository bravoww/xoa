...
double COE_i = 4.58;          //total input  coe  same direction   7C01:3.788  7C02:2.48    7C03:4.58
double COE_o = 0.0758;        //total output coe  same direction   7C01:0.0472 7C02:0.057   7C03:0.0758
u16   Bias_V = 0x480;
