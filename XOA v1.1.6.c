...
double COE_i = 2.48;          //total input coe  same direction    3.788_7b01
double COE_o = 0.057;        //total output coe  same direction   0.0472_7b01
u16   Bias_V = 0x480;
...
/*****************************************************/	
     ...
     if(status == 0x03)		    //PID works when LD enabled
	  ...
	  //SetDAC ( 0xFFF); // Effect Needed Changes 				 
		 }	
/*****************************************************/	
