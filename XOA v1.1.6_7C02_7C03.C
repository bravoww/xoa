...
#define  I_MAX           200     //max current(mA)
#define  P_MAX           100     //max Power * 10(dbm)
...
double COE_i = 2.48;          //total input  coe  same direction   7C01:3.788  7C02:2.48    7C03:4.58
double COE_o = 0.057;         //total output coe  same direction   7C01:0.0472 7C02:0.057   7C03:0.0758
u16   Bias_V = 0x480;
